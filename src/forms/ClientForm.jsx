...
export default function ClientForm({ client, onSave, onClose }) {
    const [form, setForm] = useState(client || {
        ...
        kpis: { ventas30d: 0, conversion: 0, acos: 0, tickets: 0 }
    });
        ...
        <div>
            ...
            <div style={{ marginTop: 16, padding: 14, background: "var(--bg-tertiary)", borderRadius: "var(--radius-lg)" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 10 }}>
                    <Field label="Ventas 30d"><input type="number" style={inputStyle} value={form.kpis.ventas30d} onChange={e => setKpi("ventas30d", e.target.value)} /></Field>
                    ...
                    <Field label="ACOS %"><input type="number" step="0.1" style={inputStyle} value={form.kpis.acos} onChange={e => setKpi("acos", e.target.value)} /></Field>
